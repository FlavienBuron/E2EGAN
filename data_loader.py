...
class DataLoader():
    def __init__(self, input, isNormal=False):
        ...
        # self.m=sliced_m
        # self.deltaPre = sliced_deltaPre
        # self.lastvalues = sliced_lastvalues
        # self.deltaSub = sliced_deltaSub
        # self.subvalues = sliced_subvalues
        # self.x_lengths = sliced_lengths
        # self.maxLength = max(sliced_lengths)
        # self.x = np.nan_to_num(sliced_x)
        # self.times = sliced_times
        self.m = m
...
if __name__ == '__main__':
    matrix = np.loadtxt('in/chlorine_m100.txt')
    dt = DataLoader(matrix)
    print(dt.x_lengths)